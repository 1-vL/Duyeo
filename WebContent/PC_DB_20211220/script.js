...
function checkCookie() {
  var darkStyle = getCookie("darkStyle");
	alert(darkStyle);
  if (darkStyle != "라이트모드") {
	darkStyle="다크모드"
  } else {
    if (darkStyle != "" && darkStyle != null) {
      setCookie("darkStyle", darkStyle, 365);
    }
  }
}
*/
...
$(function(){
	$(".stylebutton").click(function() {//다크모드/라이트모드
	if(getCookie("darkStyle")=="다크모드") {
		alert("ekzm");
		setCookie("darkStyle", "라이트모드", 365);
	} else if (getCookie("darkStyle")=="라이트모드") {
		alert(getCookie("darkStyle"));
